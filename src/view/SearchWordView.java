...
public class SearchWordView extends JFrame {
	...
	public SearchWordView() {
		...
		lblNewLabel_2 = new JLabel("Search Word");
		...
		JLabel lblNewLabel_4 = new JLabel("Search  Word__________________");
		lblNewLabel_4.setForeground(Color.WHITE);
		lblNewLabel_4.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel_4.setFont(new Font("Segoe UI", Font.PLAIN, 27));
		lblNewLabel_4.setBounds(10, 62, 376, 61);
	...
	public void setFirstView(DataAdminView firstView)
	{
		this.dataAdminView=firstView;
	}
